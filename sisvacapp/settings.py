"""
Django settings for sisvacapp project.
...
INSTALLED_APPS = [
    ...
    'apps.type.apps.TypeConfig',
    'apps.supplier.apps.SupplierConfig',
    'apps.vaccine.apps.VaccineConfig',
    ...
    'apps.administrationroute.apps.AdministrationrouteConfig',
]
...
WSGI_APPLICATION = 'sisvacapp.wsgi.application'
